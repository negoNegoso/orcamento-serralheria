...
const baseQuote = { customer_name: 'Maria', subtotal: 1000, discount: 0 }
...
describe('buildQuoteMessage', () => {
  ...
  it('ajuste negativo: mostra valor bruto (line_total 900 + extra -100 → R$ 1.000,00)', () => {
    const msg = buildQuoteMessage(
      { customer_name: 'João', subtotal: 900, discount: 0 },
  ...
  it('ajuste positivo: valor permanece o mesmo', () => {
    const msg = buildQuoteMessage(
      { customer_name: 'João', subtotal: 1100, discount: 0 },
  ...
  it('multiplier = 1 (padrão): sem linha "casas"', () => {
    const msg = buildQuoteMessage(
      { customer_name: 'Ana', subtotal: 500, discount: 0, multiplier: 1 },
      [{ product_name: 'Porta', line_total: 500 }],
    )
  ...
  it('desconto reduz o total', () => {
    const msg = buildQuoteMessage(
      { customer_name: 'Pedro', subtotal: 1000, discount: 100 },
